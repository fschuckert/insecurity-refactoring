...
//		String joined = "start" + SEPARATOR + "end" + SEPARATOR + "type" + SEPARATOR + StringUtils.join(edgeProperties, SEPARATOR);
		
		String joined = ":START_ID" + SEPARATOR + ":END_ID" + SEPARATOR + ":TYPE"+ SEPARATOR + StringUtils.join(edgeProperties, SEPARATOR);
