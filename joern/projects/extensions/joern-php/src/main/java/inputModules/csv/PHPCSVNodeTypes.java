...
//        public static final CSVKey FLAGS = new CSVKey("flags", "string_array");
	 ...
	 public static final CSVKey NODE_ID = new CSVKey("ID");	
	// node labels (either Filesystem, AST or Artificial)
	 public static final CSVKey LABEL = new CSVKey("LABEL");	
	...
	public static final List<String> funcTypes = Arrays.asList(TYPE_TOPLEVEL, TYPE_FUNC_DECL, TYPE_METHOD,
			TYPE_CLOSURE);
	...
	public static final String FLAG_BY_REFERENCE = "BY_REFERENCE"; // custom, see phpjoern commit
																	// 95cdc6b6de1c4b973775a97b90e8bf41c90f629b
	...
	// public static final String FLAG_TYPE_ARRAY = "TYPE_ARRAY"; // already defined
	// above
	...
	// flags for TYPE_BINARY_OP and TYPE_ASSIGN_OP nodes in version >= 20 of php-ast
	// (exclusive)
	...
	public static final String FLAG_BINARY_IS_GREATER_OR_EQUAL = "BINARY_IS_GREATER_OR_EQUAL"; // since version 20 of
																								// php-ast
