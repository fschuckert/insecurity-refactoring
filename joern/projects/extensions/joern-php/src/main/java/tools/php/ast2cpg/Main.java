...
public class Main {
	...
	public static void main(String[] args) throws InvalidCSVFile, IOException {
                 ...
                 // args = new String[]{"/home/blubbomat/Development/FindPOI/nodes.csv", "/home/blubbomat/Development/FindPOI/rels.csv"};
		...
		cfgToUDG.setASTDefUseAnalyzer(new PHPASTDefUseAnalyzer());
                ...
                // add enclosing class
//                for(Long classId : extractor.getClasseIds()){
//                    extractor.
//                }
		...
		while ((rootnode = (FunctionDef)extractor.getNextFunction()) != null) {
                        // hotfix: methods require the corresponding class
