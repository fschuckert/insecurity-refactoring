...
//    private  Neo4jDB connector;
    ...
    private JButton printJson = new JButton("Print JSON");
//    private JPanel drawPanel = new JPanel();
//    JScrollPane astTreePane;
//    private GUI gui;
    private ASTView astView = new ASTView();

    public ASTRenderer(Neo4jDB connector) {
...
//            Integer id = Integer.valueOf(idText);
            try{
                Neo4jDB conne = new Neo4JConnector("bolt://localhost:7687", "neo4j", "admin");
    ...
    private void refreshFiles(){
        ...
        Neo4jDB connector = new Neo4JConnector("bolt://localhost:7687", "neo4j", "admin");        
